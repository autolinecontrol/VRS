...
function enviarcorreos($correovisitante,$identificacion,$nombrevisitante)
{       
    ...
    $message_body = '<h1 align="right" style="color:#228b22;">VRS</h1><hr>Estimado/a. ' .$nombrevisitante.',
    <BR>
...
$nombre=$request->name;
enviarcorreos($correo,$identificacion,$nombre);
