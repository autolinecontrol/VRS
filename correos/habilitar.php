...
<title>Enviar Correos de Habilitar en Pendientes</title>
...
{       
    ...
    Felicitaciones tu foto ya ha sido aprobada,
    recuerda que tu pin es '.$pin.', y ingresas con tu documento de identificacion.<br>
